...
export class BarcodeRecognizerConfiguration extends PartiallyConstructible {
  /**
    ...
    */
  public acceptedDocumentFormats: BarcodeDocumentFormat[] = [];
  /**
    Filter for extended EAN and UPC barcodes.
    Default is NO_FILTER
    */
  public barcodesExtensionFilter: BarcodesExtensionFilter = 'NO_FILTER';
  /**
    ...
    Default is ""
    */
  public barcodesRegexFilter: string = '';
  /**
    ...
    Default is 0
    */
  public minimumTextLength: number = 0;
  /**
  ...
  /**
    ...
    Default is 10
    */
  public minimum1DBarcodesQuietZone: number = 10;
  /**
  ...
  public constructor(source: DeepPartial<BarcodeRecognizerConfiguration> = {}) {
    super();
