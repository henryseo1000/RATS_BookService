...
exports.BarcodeTextLocalization = void 0;
var _utils = require("../../utils");
/**
Configuration of the all strings for barcode scanner.
*/
class BarcodeTextLocalization extends _utils.PartiallyConstructible {
  /**
  ...
  /**
    ...
    */
  barcodeInfoMappingErrorStateSubtitle = 'There was an issue and the data requested was not fetched. You could try again or discard this result to start a new scan.';
  /**
    Retry button text for the barcode info mapping error state.
    Default is "Retry"
    */
  barcodeInfoMappingErrorStateRetryButton = 'Retry';
  /**
    Cancel button text for the barcode info mapping error state.
    Default is "Cancel"
    */
  barcodeInfoMappingErrorStateCancelButton = 'Cancel';
  /**
    Title for the manual count edit dialog.
    Default is "Update count"
    */
  manualCountEditDialogTitle = 'Update count';
  /**
  ...
  /**
    ...
    */
  sheetStartScanningButton = 'Start scanning';
  /**
  ...
  constructor(source = {}) {
    ...
    if (source.barcodeInfoMappingErrorStateCancelButton !== undefined) {
      this.barcodeInfoMappingErrorStateCancelButton = source.barcodeInfoMappingErrorStateCancelButton;
    }
...
exports.BarcodeTextLocalization = BarcodeTextLocalization;
