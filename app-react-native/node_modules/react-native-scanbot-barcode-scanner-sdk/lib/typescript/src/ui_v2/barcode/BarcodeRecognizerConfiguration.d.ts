...
*/
export type BarcodeFormat = 'AZTEC' | 'CODABAR' | 'CODE_25' | 'CODE_39' | 'CODE_93' | 'CODE_128' | 'DATA_MATRIX' | 'EAN_8' | 'EAN_13' | 'ITF' | 'PDF_417' | 'QR_CODE' | 'MICRO_QR_CODE' | 'DATABAR' | 'DATABAR_EXPANDED' | 'UPC_A' | 'UPC_E' | 'MSI_PLESSEY' | 'IATA_2_OF_5' | 'INDUSTRIAL_2_OF_5' | 'USPS_INTELLIGENT_MAIL' | 'ROYAL_MAIL' | 'JAPAN_POST' | 'ROYAL_TNT_POST' | 'AUSTRALIA_POST' | 'DATABAR_LIMITED' | 'GS1_COMPOSITE' | 'MICRO_PDF_417' | 'MAXI_CODE' | 'RMQR_CODE' | 'CODE_11' | 'CODE_32';
/**
...
//# sourceMappingURL=BarcodeRecognizerConfiguration.d.ts.map