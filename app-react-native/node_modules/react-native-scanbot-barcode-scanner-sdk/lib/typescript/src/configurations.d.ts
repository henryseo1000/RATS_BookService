import { AspectRatio, AustraliaPostCustomerFormat, BarcodeDocumentFormat, BarcodeFormat, BarcodesExtensionFilter, CameraModule, CameraPreviewMode, ConfirmationDialogConfiguration, EngineMode, FileEncryptionMode, Gs1HandlingMode, MSIPlesseyChecksumAlgorithm, OrientationLockMode, SelectionOverlayConfiguration, ZoomRange } from './types';
/**
 * @deprecated Use ***BarcodeScannerConfiguration*** from ***'react-native-scanbot-barcode-scanner-sdk/ui_v2'*** instead
 */
