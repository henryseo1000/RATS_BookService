declare namespace IMPConst {
    const PG: readonly ["html5_inicis", "inicis", "uplus", "kcp", "kcp_billing", "nice", "jtnet", "kakao", "kakaopay", "danal", "danal_tpay", "kicc", "settle", "settle_acc", "mobilians", "payco", "eximbay", "paypal", "naverco", "naverpay", "smilepay", "chai", "payple", "alipay", "bluewalnut", "tosspay", "smartro", "tosspayments", "ksnet", "daou", "nice_v2"];
