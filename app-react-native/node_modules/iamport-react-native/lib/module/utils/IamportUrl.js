...
class IamportUrl {
  ...
  constructor(url) {
    ...
    if (Platform.OS === 'ios') {
      this.path = this.scheme.startsWith('itms') ? `https://${splittedUrl[1]}` : this.url;
  ...
  isPaymentOver(redirectUrl, data) {
    if (this.url.startsWith(redirectUrl)) {
      return true;
    }
    if ((data === null || data === void 0 ? void 0 : data.pay_method) === 'trans') {
      const decodeUrl = decodeURIComponent(this.url);
      const parsedUrl = queryString.parse(decodeUrl);
      const scheme = data === null || data === void 0 ? void 0 : data.app_scheme;
      /**
      ...
      if (data.pg.startsWith('html5_inicis') && Platform.OS === 'ios') {
        var _data$app_scheme;
        const query = parsedUrl;
        if (query.m_redirect_url !== null && scheme === ((_data$app_scheme = data.app_scheme) === null || _data$app_scheme === void 0 ? void 0 : _data$app_scheme.toLowerCase())) {
          var _query$m_redirect_url;
          if ((_query$m_redirect_url = query.m_redirect_url) !== null && _query$m_redirect_url !== void 0 && _query$m_redirect_url.includes(redirectUrl)) {
            return true;
          }
        }
      }
  ...
  isAppUrl() {
    return !['http', 'https', 'about:blank', 'about:srcdoc'].includes(this.scheme);
  }
  isIframeLoaded() {
    return this.url !== 'about:blank' && !this.url.startsWith(IMPConst.IMP_SDK_URL);
  }
  getAppUrl() {
    return this.path;
  }
    ...
    if (Platform.OS === 'ios') {
      ...
      switch (this.scheme) {
        case IMPConst.ANDROID_APPSCHEME.ISP:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_ISP;
        case IMPConst.ANDROID_APPSCHEME.BANKPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_BANKPAY;
        case IMPConst.ANDROID_APPSCHEME.KB_BANKPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KB_BANKPAY;
        case IMPConst.ANDROID_APPSCHEME.NH_BANKPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_NH_BANKPAY;
        case IMPConst.ANDROID_APPSCHEME.MG_BANKPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_MG_BANKPAY;
        case IMPConst.ANDROID_APPSCHEME.KN_BANKPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KN_BANKPAY;
        case IMPConst.ANDROID_APPSCHEME.KAKAOPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KAKAOPAY;
        case IMPConst.ANDROID_APPSCHEME.SMILEPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_SMILEPAY;
        case IMPConst.ANDROID_APPSCHEME.CHAIPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_CHAIPAY;
        case IMPConst.ANDROID_APPSCHEME.PAYCO:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_PAYCO;
        case IMPConst.ANDROID_APPSCHEME.HYUNDAICARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_HYUNDAICARD;
        case IMPConst.ANDROID_APPSCHEME.TOSS:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_TOSS;
        case IMPConst.ANDROID_APPSCHEME.SHINHANCARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_SHINHANCARD;
        case IMPConst.ANDROID_APPSCHEME.SHINHANSUPERSOL:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_SHINHANSUPERSOL;
        case IMPConst.ANDROID_APPSCHEME.HANACARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_HANACARD;
        case IMPConst.ANDROID_APPSCHEME.SAMSUNGCARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_SAMSUNGCARD;
        case IMPConst.ANDROID_APPSCHEME.KBCARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KBCARD;
        case IMPConst.ANDROID_APPSCHEME.NHCARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_NHCARD;
        case IMPConst.ANDROID_APPSCHEME.CITICARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_CITICARD;
        case IMPConst.ANDROID_APPSCHEME.LOTTECARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_LOTTECARD;
        case IMPConst.ANDROID_APPSCHEME.LPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_LPAY;
        case IMPConst.ANDROID_APPSCHEME.SSGPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_SSGPAY;
        case IMPConst.ANDROID_APPSCHEME.KPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KPAY;
        case IMPConst.ANDROID_APPSCHEME.KBANKPAY:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KBANKPAY;
        case IMPConst.ANDROID_APPSCHEME.PAYNOW:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_PAYNOW;
        case IMPConst.ANDROID_APPSCHEME.WOORIWONCARD:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_WOORIWONCARD;
        case IMPConst.ANDROID_APPSCHEME.LPOINT:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_LPOINT;
        case IMPConst.ANDROID_APPSCHEME.KTFAUTH:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KTFAUTH;
        case IMPConst.ANDROID_APPSCHEME.LGTAUTH:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_LGTAUTH;
        case IMPConst.ANDROID_APPSCHEME.SKTAUTH:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_SKTAUTH;
        case IMPConst.ANDROID_APPSCHEME.WOORIWONBANK:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_WOORIWONBANK;
        case IMPConst.ANDROID_APPSCHEME.KAKAOBANK:
          return IMPConst.ANDROID_MARKET_PREFIX + IMPConst.ANDROID_PACKAGE.PACKAGE_KAKAOBANK;
        default:
          return this.url;
      }
    } else {
  ...
  getInicisTransQuery(redirectUrl) {
    const {
      m_redirect_url,
      imp_uid,
      merchant_uid
    ...
    if (m_redirect_url !== null && m_redirect_url !== void 0 && m_redirect_url.includes(redirectUrl)) {
